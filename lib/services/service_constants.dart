mixin ServiceName {
    ...
    static const String Get_Token = "api/NhanVien";
    ...
    static const String UploadDocument= "MB2/MbSvc2.svc/UploadDocument?subsidiaryId=%s";
    ...
    static const String Getaprrovetriprecords = "api/etp/support/getaprrovetriprecords";
    static const String Deletetriprecord = "api/etp/support/deletetriprecord";
    static const String Get_Triprecordsmobileapp = "api/etp/support/gettriprecordsmobileapp";
    ...
    static const String Getlastedversion = "api/ssocommonservice/getlastedversion/MB_ENT";
    static const String GetAnnouncements = "api/etp/announcement/getformobile/";
    static const String SaveAnnouncementEndorse = "api/etp/announcement/insertendorse";
