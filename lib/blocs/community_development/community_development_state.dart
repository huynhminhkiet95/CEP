...
class CommunityDevelopmentState extends BlocState {
  ...
  factory CommunityDevelopmentState.init() {
    return CommunityDevelopmentState(isLoading: false, isLoadingSaveData: false);
  }
  ...
  factory CommunityDevelopmentState.updateLoadingSaveData(bool isLoadingSaveData) {
    return CommunityDevelopmentState(
