...
class TableCalendar extends StatefulWidget {
  ...
  final Map<DateTime, List<Aprrovetriprecords>> events;
...
class _TableCalendarState extends State<TableCalendar>
  ...
  void _selectedDayCallback(DateTime day) {
    if (widget.onDaySelected != null) {
      final key = widget.calendarController.visibleEvents.keys
          .firstWhere((it) => Utils.isSameDay(it, day), orElse: () => null);
      widget.onDaySelected(
          day, widget.calendarController.visibleEvents[key] ?? []);
    }
  }
  ...
  Widget _buildMarker(DateTime date, Aprrovetriprecords event) {
    if (widget.builders.singleMarkerBuilder != null) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          color: getColor(event.approved, event.isApprovel),
        ),
      );
    }
  }
