...
class UserRoles {
  ...
  UserRoles.fromJson(Map<String, dynamic> json) {
    ...
    if(json["H-PQLNLHC"] is bool)
      this.hPqlnlhc = json["H-PQLNLHC"];
    if(json["BanTGD"] is bool)
      this.banTgd = json["BanTGD"];
    if(json["Administrator"] is bool)
      this.administrator = json["Administrator"];
    if(json["TD"] is bool)
      this.td = json["TD"];
    if(json["GiaoDich"] is bool)
      this.giaoDich = json["GiaoDich"];
    if(json["KTV"] is bool)
      this.ktv = json["KTV"];
    if(json["TQ"] is bool)
      this.tq = json["TQ"];
    if(json["KiemSoat2"] is bool)
      this.kiemSoat2 = json["KiemSoat2"];
    if(json["H-HS"] is bool)
      this.hHs = json["H-HS"];
    if(json["H-PTCKT"] is bool)
      this.hPtckt = json["H-PTCKT"];
    if(json["GDCN"] is bool)
      this.gdcn = json["GDCN"];
    if(json["Provisional"] is bool)
      this.provisional = json["Provisional"];
    if(json["PTCD"] is bool)
      this.ptcd = json["PTCD"];
    if(json["H-PCNTT"] is bool)
      this.hPcntt = json["H-PCNTT"];
    if(json["DataBase"] is bool)
      this.dataBase = json["DataBase"];
    if(json["TPKT"] is bool)
      this.tpkt = json["TPKT"];
    if(json["ChiNhanh"] is bool)
      this.chiNhanh = json["ChiNhanh"];
    if(json["KiemSoat"] is bool)
      this.kiemSoat = json["KiemSoat"];
    if(json["THIONLINE"] is bool)
      this.thionline = json["THIONLINE"];
    if(json["TTTD"] is bool)
      this.tttd = json["TTTD"];
    if(json["H-PQLTD"] is bool)
      this.hPqltd = json["H-PQLTD"];
    if(json["H-PHLPTD"] is bool)
      this.hPhlptd = json["H-PHLPTD"];
    if(json["TPTD"] is bool)
      this.tptd = json["TPTD"];
    if(json["UpLoad"] is bool)
      this.upLoad = json["UpLoad"];
    if(json["H-PKTNB"] is bool)
      this.hPktnb = json["H-PKTNB"];
  }
